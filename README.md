Moving on to some searching algorithms using Python 3.5.x
...
Next up: [KMP search] (https://github.com/nryoung/algorithms/blob/master/algorithms/searching/kmp_search.py)
